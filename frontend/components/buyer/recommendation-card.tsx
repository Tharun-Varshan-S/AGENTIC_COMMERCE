...
export function RecommendationCard({ recommendation, onAddToCart }: RecommendationProps) {
    ...
    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 rounded-2xl p-5 shadow-sm relative overflow-hidden mt-6">
      ...
      <div className="bg-white rounded-xl p-4 border border-indigo-100/50 shadow-sm relative z-10 flex flex-col md:flex-row gap-4 items-start md:items-center">
        ...
        <button
          ...
          className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-2.5 text-sm font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 disabled:opacity-50 disabled:hover:bg-indigo-600 transition-colors shadow-sm shadow-indigo-200 shrink-0"
        >
